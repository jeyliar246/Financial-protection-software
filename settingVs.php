                ...
                <div class="panel-body">
                    <div class="col-sm-6 col-md-6">
                        ...
                        $email = $_SESSION['username'];
                            ...
                            $ac_info_sql = "SELECT id, trans_limit FROM account WHERE id=".$user_pk;
                        ...
                        if($status == 0) {
                            echo '
                                ...
                                <span class="check-label">Activate</span>
                            ';
                        }else {
                            echo '
                                <input class="custom-checkbox" type="checkbox" name="status" value="0">
                                <span class="check-label">Deactivate</span>
                            ';
                        }
