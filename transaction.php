...
<head>
	...
	<title>Transaction | Credit Card Fraud Detection</title>
		...
		<?php
			if(isset($_SESSION['account'])) {
				...
				if($blocked_last_row->num_rows > 0) {
					...
					// Show Warning
					echo '<p class="warning-message">Someone tried to access your account from <strong>'.$blocked_branch_name.'</strong> at <strong>'.$blocked_timestamp.'</strong></p>';
				}
